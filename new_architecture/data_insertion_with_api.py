...
DATA_DIR = os.getenv("DATA_INSERTION_DIRECTORY")  # ? REPLACE THIS
...
#     {
#         # --- REPLACE THESE ----------------------------------
#         "file_path": "/home/hooman/Downloads/RagBotData/???? ???? ?????? ??????? ??? ????? ????.pdf",
#         "chunk_dir": "/home/hooman/PycharmProjects/RegAssist/data_insertion_chunks/???? ???? ?????? ??????? ??? ????? ????",
#         # ----------------------------------------------------
#         "title": "???? ???? ?????? ??????? ??? ????? ????",
#         "owner": "johndoe",
